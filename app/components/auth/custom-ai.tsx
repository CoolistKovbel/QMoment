  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 w-full">
        <div className="w-[50%] flex flex-col justify-between h-[300px] drop-shadow-lg rounded-md  bg-[#222] ">
          <label
            htmlFor="botName"
          ...
          <label
            htmlFor="ImageName"
            className="bg-[#121] p-2 rounded-md flex items-center justify-between bg-shadow-lg text-333 font-bold p-4 w-[60%]"
          >
            <span>Bot Image:</span>
        ...
        <div className="w-[50%] h-[300px] drop-shadow-lg rounded-md bg-[#222]"></div>
      </div>
