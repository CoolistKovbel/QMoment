...
const GetNFTModel = () => {
  ...
  const isModalOpen = isOpen && type === "getNFT";
    ...
    >
      <div className="bg-[#222] rounded-md p-4 w-96 h-[50%]">
        ...
        <div className="w-full h-full text-white flex justify-between flex-col ">
          <h2 className="text-2xl md:text-4xl text-center font-bold">Mint NFT Today</h2>
          ...
          <div>
            ...
            <p className="text-sm text-center text-gray-500">
              Tired of missing out? Get yourself situated with Pro Membership Pin. Each New pin comes out onces a collection runs out, how many are you going to collect, will you be the one to collect them all?
            </p>
